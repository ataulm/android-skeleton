...
public class BigGridRecyclerViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_big_grid_recycler_view);
    ...
    private static class Examples extends RecyclerView.Adapter<Examples.LetterViewHolder> {
        ...
        public LetterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = layoutInflater.inflate(R.layout.view_big_letter_item, parent, false);
