...
/**
 * These tests don't make sense. They are here only to show that MovieFixtures is accessible and usable from mobile/test test classes.
 */
public class MoviesAndroidUnitTest {
