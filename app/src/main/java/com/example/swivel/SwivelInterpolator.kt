...
internal class SwivelInterpolator private constructor(private val values: FloatArray) : Interpolator {
    ...
    companion object {
        ...
        /**
         * Copied from [android.support.v4.view.animation.FastOutSlowInInterpolator]
         */
